...
/* gauge    */
		...
		/* gif 사진 css */
		  ...
		  .gif_testimg {
			...
			.gif_test:hover { flex: 1 1 50%; }
			.box:hover > img {
			  width: 100%;
			  height: 100%;
			}
			
			/* mask_score 시연영상 설명문구 css*/
               ...
               <div id="main">
                  <div class="inner">
                     <div style="display: block;">
                        <img src="images/care.png" style="width:200px; height:40px; margin-top: 20px;"><br>
                     </div>
                     <!-- Header -->
                     ...
                     <div> <!-- style="background-color: #fff; width: 700px; height: 600px;" -->
                           ...
                           <section> <!-- color: #9E9E9E; -->
                              <header class="major">
                                 ...
                                 <h1 style="font-family: 나눔고딕; color:#263238!important; padding: 10px; margin-bottom:50px; margin-top: 50px" class="mb-5 text-primary font-weight-bold"  data-aos="fade-up" style="width: 100px;">
                               
	                                 <span style="color: #0058A8; font-family: GmarketSansBold;">CARE</span>
	                                 <span style="font-family: GmarketSansBold;">-ZONE</span>에서<br>  
	                                 <span style="font-family: 나눔고딕; color:#263238 ;" class="typed-words">편리하게 보여드립니다.</span></h1>
                        ...
                        <section id="banner">
                           <div class="content">
                              ...
                              <header>
                                 ...
                                 text-align: left;
                                 background-color: slateblue(250,250,250);">Map Page</h5><br>
                              </header>
                           </div><br>
                              ...
                              <!-- <div  style="background-color: #8EA3CA; width: 1000px">
                               ...
                               -->
                                     ...
                                     <img src="images/red_test.png;" style="width: 30px; height: 30px; margin-right: 10px;" align="left"><h3 style="font-family: 나눔고딕; font-size: 20px; color: #000;">장소를 선택하세요.</h3>
                                     <img src="images/red_test.png;" style="width: 30px; height: 30px; margin-right: 10px;" align="left"><h3 style="font-family: 나눔고딕; font-size: 20px; color: #000;">장소를 선택하고 상세보기 버튼을 눌러 안전점수를 확인하세요.</h3>
                                    ...
                                    function displayInfowindow(marker, title) {
                                       ...
                                       $.ajax({
                                                      ...
                                                      success : function(data) {
                                                         ...
                                                         var title = data.STORE_NAME;
                                                         
                                                         var STORE_MASK1 = (data.STORE_MASK1/1000)*100;
                                                         var STORE_MASK2 = (data.STORE_MASK2/1000)*100;
                                                         var STORE_MASK3 = (data.STORE_MASK3/1000)*100;
                                                         
                                                         var STORE_PREVENTION1 = (data.STORE_PREVENTION1/20)*100;
                                                         var STORE_PREVENTION2 = (data.STORE_PREVENTION2/20)*100;
                                                         var STORE_PREVENTION3 = (data.STORE_PREVENTION3/20)*100;
                                                         
                                                         if(81 <= STORE_MASK3){
                                                        	 $('#A').attr("src","images/smile_1.png");
                                                         }else if(51 <= STORE_MASK3){
                                                        	 $('#A').attr("src","images/smile_2.png");
                                                         }else{
                                                        	 $('#A').attr("src","images/smile_3.png");
                                                         }
                                                         ...
                                                         function drawChart() {
                                                           var data = google.visualization.arrayToDataTable([
                                                             ['주간', '마스크 착용률 점수', '방역실시점수'],
                                                             ['2주전', STORE_MASK1, STORE_PREVENTION1],
                                                             ['1주전', STORE_MASK2, STORE_PREVENTION2],
                                                             ['최근', STORE_MASK3, STORE_PREVENTION3]
                                                           ]);
                        ...
                        <div id="score_test">
                           <div style="background-color: #8EA3CA; width: 1000px; height: 50px;">
                              ...
                              <section class="demo-3" style="font-family: 나눔고딕;">
                                 ...
                                 <!-- 0925 희정이 -->
                                 <img id="A" src="" style="position: absolute; display: block; margin-left: 250px; width: 100px;">
                                 <div id="STORE_NAME" style="font-family: 나눔고딕; font-weight: bold; font-size: 20px; color: #000;"></div>
                                 <div id="STORE_TYPE"style="font-weight: bold;"></div>
                                  <div id="STORE_LOCATION" style="font-family: 나눔고딕; font-weight: bold; font-size: 20px; color: #000;"></div>
                                 <div id="STORE_TEL" style="font-family: 나눔고딕; font-weight: bold; font-size: 20px; color: #000;"></div>
                               ...
                               <div>
		                           <div style="background-color: #8EA3CA; width: 1000px; height: 50px">
		                              <header>
		                                 ...
		                                 border-bottom-width: 1px;
		                                 letter-spacing: -0.07em;
		                                 background-color: slateblue(250,250,250);">시연영상</h5>
		                              </header>
                                ...
                                <div>
	                                <span id="mask_score">
			                                  <img src="images/red_test.png;" style="width: 30px; height: 30px; margin-right: 10px;" align="left"><h3 style="font-family: 나눔고딕; font-size: 20px; color: #000; font-weight: bold;">저희 caer-zone은 딥러닝을 통한 마스크 인식, 사람인식, 방역기인식을 통해 분석을 진행합니다.</h3>
			                                  <img src="images/red_test.png;" style="width: 30px; height: 30px; margin-right: 10px;" align="left"><h3 style="font-family: 나눔고딕; font-size: 20px; color: #000;">영상 위에 마우스를 올리시면 더 자세하게 볼수있습니다.</h3>
			                         </span>
                                </div><br>
                              
                                
                                <div class="gif_testimg" style="margin: 0px; text-align: center; font-family: 나눔고딕;">
                             <div class="gif_test">
                               <img src="images/vidio_01.gif" style="width: 600px; height: 360px">
                               <!-- <span>마스크</span>  -->
                               <img src="images/text_01.png" style="width: 530px; height: 270px; margin-top: 30px;" > 
                             </div>
                             
                             
                             <div class="gif_test">
                               <img src="images/vidio_02.gif" style="width: 600px; height: 360px; ">
                              
                               <img src="images/text_02.png" style="width: 530px; height: 270px; margin-top: 30px;" >
                             </div>
                  ...
                  <div class="inner" >
                     ...
                     <!-- Section -->
                        <section style="margin: 0px;">
                           <header class="major">
                              <h3 style="font-family: 나눔고딕; font-size: 25pt; color: #000; text-align: center;">실시간 코로나 상황</h3>
                           </header>
                        ...
                        <article>
                              ...
                              <div style="border: 5px solid #fff; font-family: 나눔고딕">
                                 ...
                                 <div style="background-color: #0058A8;">
                                    <span style="font-size: 15pt; font-family: 나눔고딕; color: #fff;">확진환자</span>
                                 </div>
                                 <div style="color: #000">
                                 <div style="background-color: #0058A8;">
                                    <span style="font-size: 25pt; font-family: 나눔고딕; color: #fff"><%=list.get(0).getText()%>명</span>
                                 </div><br>
                                 <div style="font-size: 15px">
                                 <div><span align="center" style="padding: 0px 10px 1px;
                                 margin: 10px 0px 5px;
                                 border-left-width: 5px;
                                 border-left-style: solid;
                                 ...
                                 text-align: cente;
                                 font-weight: bold;
                                 background-color: slateblue(250,250,250);">치료중 : &nbsp<%=list.get(1).getText()%>명</span>
                                 </div>
                                 <div align="center">
                                    <span align="center" style="padding: 0px 10px 1px;
                                 margin: 10px 0px 5px;
                                 border-left-width: 5px;
                                 border-left-style: solid;
                                 ...
                                 text-align: cente;
                                 font-weight: bold;
                                 background-color: slateblue(250,250,250);">격리해제 : &nbsp<%=list.get(2).getText()%>명</span>
                                 </div>
                                 <div align="center">
                                    <span align="center" style="padding: 0px 10px 1px;
                                 margin: 10px 0px 5px;
                                 ...
                                 text-align: cente;
                                 font-weight: bold;
                                 background-color: slateblue(250,250,250);">사망 : &nbsp<%=list.get(3).getText()%>명</span>
                                 </div>
                                 </div>
                                 </div>
                              </div><br>
                              ...
                              <div style="border: 5px solid #fff; font-family: 나눔고딕">
                                 ...
                                 <div style="background-color: #0058A8;">
                                    <span style="font-size: 15pt; font-family: 나눔고딕; color: #fff">검사현황</span>
                                 </div>
                                 <div style="color: #000">
                                 <div style="background-color: #0058A8;">
                                    <span style="font-size: 25pt; font-family: 나눔고딕; color: #fff"><%=list.get(4).getText()%>명</span>
                                 </div><br>
                                 <div style="font-size: 15px">
                                 <div align="center">
                                 ...
                                 text-align: cente;
                                 font-weight: bold;
                                 background-color: slateblue(250,250,250);">양성 : &nbsp<%=list.get(5).getText()%>명</span> 
                                 </div>
                                 <div align="center">
                                    <span align="center" style="padding: 0px 10px 1px;
                                 margin: 10px 0px 5px;
                                 ...
                                 text-align: cente;
                                 font-weight: bold;
                                 background-color: slateblue(250,250,250);">음성 : &nbsp<%=list.get(6).getText()%>명</span>
                                 </div>
                              ...
                              <div style="border: 5px solid #fff; font-family: 나눔고딕">
                                 ...
                                 <div style="background-color: #0058A8;">
                                    <span style="font-size: 15pt; font-family: 나눔고딕; color: #fff">접촉자</span>
                                 </div>
                                 <div style="background-color: #0058A8;">
                                    <span style="font-size: 25pt; font-family: 나눔고딕; color: #fff"><%=list.get(8).getText()%>명</span>
                                 </div><br>
                                 <div style="font-size: 15px">
                                 <div style="color: #000"> 
                                 <div align="center">
                                 ...
                                 text-align: cente;
                                 font-weight: bold;
                                 background-color: slateblue(250,250,250);">격리중 : &nbsp<%=list.get(9).getText()%>명</span>
                                 </div>
                                 <div align="center">
                                    <span align="center" style="padding: 0px 10px 1px;
                                 margin: 10px 0px 5px;
                                 ...
                                 text-align: cente;
                                 font-weight: bold;
                                 background-color: slateblue(250,250,250);">격리해제 : &nbsp<%=list.get(10).getText()%>명</span>
                                 </div>
                                 </div>
                                 </div>
                                 </div>
                              ...
                              <div style="border: 5px solid #fff; font-family: 나눔고딕">
                                 ...
                                 <div style="background-color: #0058A8;">
                                    <span style="font-size: 15pt; font-family: 나눔고딕; color: #fff">자치구별 발생 현황</span>
                                 </div><br>
                                 <div style="font-size: 15px">
                                 <div style="color: #000">
                                 <div align="center" style="font-weight: bold;">
                              ...
                              <article>
                                 <header class="major">
                                    <h3 align="center" style="font-family: 나눔고딕; font-size: 25pt; text-align: center; color: #000">광주 선별 진료소</h3>
                                 </header>
                     ...
                     <!-- Section -->
                        <section style="font-family: 나눔고딕">
                           ...
                           <p>CCTV를 통해  마스크 착용여부 비율, 착용시간을 분석과 이용자 수를 분석하여 
