                        ...
                        <div id="score_test">
                           <div style="background-color: #8EA3CA; width: 1000px; height: 50px">
                              ...
                              <section class="demo-3" style="font-family: 나눔고딕;">
                                 ...
                                 <div id="STORE_TYPE"></div>
                                 <div id="STORE_LOCATION"></div>
                                 <div id="STORE_TEL"></div>
                                 ...
                                 <!-- <div class="box" style="color: #000000; font-size: 30px">   
                                      ...
                                      <div class="progress" style="height: 25px;">
    								  	<div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"  style="width:80%;">
      									나쁨
    									</div>
  									  </div>
                  ...
                  <div class="inner" >
                     ...
                     <!-- Section -->
                        <section style="margin: 0px;">
                           <header class="major">
                              <h3 style="text-align:center; font-family: 나눔고딕; font-size: 25pt; color: #000">실시간 코로나 상황</h3>
                           </header>
                        ...
                        <article>
                              ...
                              <article>
                                 <header class="major">
                                    <h3 style="text-align:center; font-family: 나눔고딕; font-size: 25pt;">광주 선별 진료소</h3>
                                 </header>
