                              ...
                              <section class="demo-3" style="font-family: 나눔고딕;">
                                 <div class="grid">
                                    <div class="box" style="color: #000000; font-size: 30px">   
                                      ...
                                      <div align="left">
                                           <span style="font-size: 15px">받아올 값 : <span id="co"></span></span>
                                          <span style="font-size: 15px">받아올 값 : <span id="co1"></span></span>
                        ...
                        <article>
                              ...
                              <div style="border: 5px solid #fff; font-family: 나눔고딕">
                                 ...
                                 <div style="background-color: #8EA3CA; opacity: 0.8;">
                                    <span style="font-size: 15pt; font-family: 나눔고딕">확진환자</span>
                                 </div>
                                 <div>
                                 <div style="background-color: #8EA3CA; opacity: 0.8;">
                                    <span style="font-size: 15px; font-family: 나눔고딕"><%=list.get(0).getText()%>명</span>
                                 </div><br>
                                 <div align="left">
                                    <span>치료중 : <%=list.get(1).getText()%>명</span>
                                 </div>
                                 <div align="left">
                                    <span>격리해제 : <%=list.get(2).getText()%>명</span>
                                 </div>
                                 <div align="left">
                                    <span>사망 : <%=list.get(3).getText()%>명</span>
                                 </div>
                                 </div>
                              </div><br>
                              ...
                              <div style="border: 5px solid #fff; font-family: 나눔고딕">
                                 ...
                                 <div style="background-color: #8EA3CA; opacity: 0.8;">
                                    <span style="font-size: 15pt; font-family: 나눔고딕">검사현황</span>
                                 </div>
                                 <div style="background-color: #8EA3CA; opacity: 0.8;">
                                    <span style="font-size: 15px; font-family: 나눔고딕"><%=list.get(4).getText()%>명</span>
                                 </div><br>
                                 <div align="left">
                                    <span>양성 : <%=list.get(5).getText()%>명</span> 
                                 </div>
                                 <div align="left">
                                    <span>음성 : <%=list.get(6).getText()%>명</span>
                                 </div>
                                 <div align="left">
                                    <span>검사중 : <%=list.get(7).getText()%>명</span>
                                 </div>
                              </div><br>      
                              ...
                              <div style="border: 5px solid #fff; font-family: 나눔고딕">
                                 ...
                                 <div style="background-color: #8EA3CA; opacity: 0.8;">
                                    <span style="font-size: 15pt; font-family: 나눔고딕">접촉자</span>
                                 </div>
                                 <div style="background-color: #8EA3CA; opacity: 0.8;">
                                    <span style="font-size: 15px; font-family: 나눔고딕"><%=list.get(8).getText()%>명</span>
                                 </div><br>
                                 <div align="left">
                                    <span>격리중 : <%=list.get(9).getText()%>명</span>
                                 </div>
                                 <div align="left">
                                    <span>격리해제 : <%=list.get(10).getText()%>명</span>
                                 </div>
                              </div><br>
                              ...
                              <div style="border: 5px solid #fff; font-family: 나눔고딕">
                                 ...
                                 <div style="background-color: #8EA3CA; opacity: 0.8;">
                                    <span style="font-size: 15pt; font-family: 나눔고딕">자치구별 발생 현황</span>
                                 </div><br>
                                 <div align="left">
                                    <span>동구 : <%=list.get(11).getText()%>명</span>
                                 </div>
                                 <div align="left">
                                    <span>서구 : <%=list.get(12).getText()%>명</span>
                                 </div>
                                 <div align="left">
                                    <span>남구 : <%=list.get(13).getText()%>명</span>
                                 </div>
                                 <div align="left">
                                    <span>북구 : <%=list.get(14).getText()%>명</span>
                                 </div>
                                 <div align="left">
                                    <span>광산구 : <%=list.get(15).getText()%>명</span>
                                 </div>
                              </div>   
